...
public class ProcedimentoController {
   ...
   //Cadastrar pedido
   @PostMapping
   public ResponseEntity<ProcedimentosCompletoDto> cadastrarPedido(@RequestBody @Valid ProcedimentosCompletoDto pedido)
   {
       return new ResponseEntity<>(servico.CadastrarNome(pedido),HttpStatus.CREATED);
   }  
